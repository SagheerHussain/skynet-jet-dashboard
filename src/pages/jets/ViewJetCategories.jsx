...
import { getAircraftCategories, deleteAircraftCategory, deleteAircraftCategoriesByBulk } from "../../api/aircraftCategory.api";
import GridLinearLoader from "../../GridLinearLoader";

const numberFmt = new Intl.NumberFormat("en-US");

const ViewJetCategories = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      if (confirm.mode === "single") {
        await deleteAircraftCategory(confirm.ids[0]);
      } else {
        await deleteAircraftCategoriesByBulk(confirm.ids);
        setSelection([]);
      }
...
export default ViewJetCategories;
