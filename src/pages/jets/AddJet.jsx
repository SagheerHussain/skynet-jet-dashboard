...
//     try {
//       setUploading(true);
//       // Build description JSON from sections (each contains HTML from Quill)
//       const description = {
//         version: 1,
//         sections: Object.fromEntries(SECTION_KEYS.map((k) => [k, { html: values.sections[k] || '' }]))
//       };

//       // Build contactAgent JSON
//       const contactAgent = {
...
//               <TextField label="Category (ObjectId)" fullWidth required {...register('category', { required: true })} />
//             </Grid> */}
//             <Grid item xs={12} md={4}>
